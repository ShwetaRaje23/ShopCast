...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////     // 3
//                                                                                                            //     // 4
// packages/iron:layout/version_conflict_errors.js                                                            //     // 5
//                                                                                                            //     // 6
////////////////////////////////////////////////////////////////////////////////////////////////////////////////     // 7
                                                                                                              //     // 8
var errors = [];                                                                                              // 1   // 9
                                                                                                              // 2   // 10
if (Package['cmather:iron-layout']) {                                                                         // 3   // 11
  errors.push("\n\n\
  ...
  ");                                                                                                         // 19  // 27
                                                                                                              ...
                                                                                                              // 21  // 29
// If the user still has blaze-layout throw  an error. Let's get rid of that                                  // 22  // 30
// package so it's not lingering around with all its nastiness.                                               // 23  // 31
if (Package['cmather:blaze-layout']) {                                                                        // 24  // 32
  errors.push(                                                                                                // 25  // 33
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////     // 53
//                                                                                                            //     // 54
// packages/iron:layout/template.default_layout.js                                                            //     // 55
//                                                                                                            //     // 56
////////////////////////////////////////////////////////////////////////////////////////////////////////////////     // 57
                                                                                                              //     // 58
                                                                                                              // 1   // 59
Template.__checkName("__IronDefaultLayout__");                                                                // 2   // 60
Template["__IronDefaultLayout__"] = new Template("Template.__IronDefaultLayout__", (function() {              // 3   // 61
  var view = this;                                                                                            // 4   // 62
  return Spacebars.include(view.lookupTemplate("yield"));                                                     // 5   // 63
}));                                                                                                          // 6   // 64
                                                                                                              // 7   // 65
////////////////////////////////////////////////////////////////////////////////////////////////////////////////     // 66
                                                                                                                     // 67
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////     // 77
//                                                                                                            //     // 78
// packages/iron:layout/layout.js                                                                             //     // 79
//                                                                                                            //     // 80
////////////////////////////////////////////////////////////////////////////////////////////////////////////////     // 81
                                                                                                              //     // 82
/*****************************************************************************/                               // 1   // 83
/* Imports */                                                                                                 // 2   // 84
/*****************************************************************************/                               // 3   // 85
var DynamicTemplate = Iron.DynamicTemplate;                                                                   // 4   // 86
var inherits = Iron.utils.inherits;                                                                           // 5   // 87
                                                                                                              // 6   // 88
/*****************************************************************************/                               // 7   // 89
/* Helpers */                                                                                                 // 8   // 90
/*****************************************************************************/                               // 9   // 91
/**                                                                                                           // 10  // 92
 * Find the first Layout in the rendered parent hierarchy.                                                    // 11  // 93
 */                                                                                                           // 12  // 94
findFirstLayout = function (view) {                                                                           // 13  // 95
  while (view) {                                                                                              // 14  // 96
    if (view.name === 'Iron.Layout')                                                                          // 15  // 97
      return view.__dynamicTemplate__;                                                                        // 16  // 98
    else                                                                                                      // 17  // 99
      view = view.parentView;                                                                                 // 18  // 100
  }                                                                                                           // 19  // 101
                                                                                                              // 20  // 102
  return null;                                                                                                // 21  // 103
};                                                                                                            // 22  // 104
...
/*****************************************************************************/                               // 26  // 108
                                                                                                              // 27  // 109
/**                                                                                                           // 28  // 110
 * Dynamically render templates into regions.                                                                 // 29  // 111
 *                                                                                                            // 30  // 112
 * Layout inherits from Iron.DynamicTemplate and provides the ability to create                               // 31  // 113
 * regions that a user can render templates or content blocks into. The layout                                // 32  // 114
 * and each region is an instance of DynamicTemplate so the template and data                                 // 33  // 115
 * contexts are completely dynamic and programmable in javascript.                                            // 34  // 116
 */                                                                                                           // 35  // 117
Layout = function (options) {                                                                                 // 36  // 118
  var self = this;                                                                                            // 37  // 119
                                                                                                              // 38  // 120
  Layout.__super__.constructor.apply(this, arguments);                                                        // 39  // 121
                                                                                                              // 40  // 122
  options = options || {};                                                                                    // 41  // 123
  this.name = 'Iron.Layout';                                                                                  // 42  // 124
  this._regions = {};                                                                                         // 43  // 125
  this._regionHooks = {};                                                                                     // 44  // 126
  this.defaultTemplate('__IronDefaultLayout__');                                                              // 45  // 127
                                                                                                              // 46  // 128
  // if there's block content then render that                                                                // 47  // 129
  // to the main region                                                                                       // 48  // 130
  if (options.content)                                                                                        // 49  // 131
    this.render(options.content);                                                                             // 50  // 132
};                                                                                                            // 51  // 133
                                                                                                              // 52  // 134
/**                                                                                                           // 53  // 135
 * The default region for a layout where the main content will go.                                            // 54  // 136
 */                                                                                                           // 55  // 137
DEFAULT_REGION = Layout.DEFAULT_REGION = 'main';                                                              // 56  // 138
                                                                                                              // 57  // 139
/**                                                                                                           // 58  // 140
 * Inherits from Iron.DynamicTemplate which gives us the ability to set the                                   // 59  // 141
 * template and data context dynamically.                                                                     // 60  // 142
 */                                                                                                           // 61  // 143
inherits(Layout, Iron.DynamicTemplate);                                                                       // 62  // 144
                                                                                                              // 63  // 145
/**                                                                                                           // 64  // 146
 * Return the DynamicTemplate instance for a given region. If the region doesn't                              // 65  // 147
 * exist it is created.                                                                                       // 66  // 148
 *                                                                                                            // 67  // 149
 * The regions object looks like this:                                                                        // 68  // 150
 *                                                                                                            // 69  // 151
 *  {                                                                                                         // 70  // 152
 *    "main": DynamicTemplate,                                                                                // 71  // 153
 *    "footer": DynamicTemplate,                                                                              // 72  // 154
 *    .                                                                                                       // 73  // 155
 *    .                                                                                                       // 74  // 156
 *    .                                                                                                       // 75  // 157
 *  }                                                                                                         // 76  // 158
 */                                                                                                           // 77  // 159
Layout.prototype.region = function (name, options) {                                                          // 78  // 160
  return this._ensureRegion(name, options);                                                                   // 79  // 161
};                                                                                                            // 80  // 162
                                                                                                              // 81  // 163
/**                                                                                                           // 82  // 164
 * Destroy all child regions and reset the regions map.                                                       // 83  // 165
 */                                                                                                           // 84  // 166
Layout.prototype.destroyRegions = function () {                                                               // 85  // 167
  _.each(this._regions, function (dynamicTemplate) {                                                          // 86  // 168
    dynamicTemplate.destroy();                                                                                // 87  // 169
  });                                                                                                         // 88  // 170
                                                                                                              // 89  // 171
  this._regions = {};                                                                                         // 90  // 172
};                                                                                                            // 91  // 173
                                                                                                              // 92  // 174
/**                                                                                                           // 93  // 175
 * Set the template for a region.                                                                             // 94  // 176
 */                                                                                                           // 95  // 177
Layout.prototype.render = function (template, options) {                                                      // 96  // 178
  // having options is usually good                                                                           // 97  // 179
  options = options || {};                                                                                    // 98  // 180
                                                                                                              // 99  // 181
