...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////     // 53
//                                                                                                            //     // 54
// packages/iron:layout/layout.js                                                                             //     // 55
//                                                                                                            //     // 56
////////////////////////////////////////////////////////////////////////////////////////////////////////////////     // 57
                                                                                                              //     // 58
/*****************************************************************************/                               // 1   // 59
/* Imports */                                                                                                 // 2   // 60
/*****************************************************************************/                               // 3   // 61
var DynamicTemplate = Iron.DynamicTemplate;                                                                   // 4   // 62
var inherits = Iron.utils.inherits;                                                                           // 5   // 63
                                                                                                              // 6   // 64
/*****************************************************************************/                               // 7   // 65
/* Helpers */                                                                                                 // 8   // 66
/*****************************************************************************/                               // 9   // 67
/**                                                                                                           // 10  // 68
 * Find the first Layout in the rendered parent hierarchy.                                                    // 11  // 69
 */                                                                                                           // 12  // 70
findFirstLayout = function (view) {                                                                           // 13  // 71
  while (view) {                                                                                              // 14  // 72
    if (view.name === 'Iron.Layout')                                                                          // 15  // 73
      return view.__dynamicTemplate__;                                                                        // 16  // 74
    else                                                                                                      // 17  // 75
      view = view.parentView;                                                                                 // 18  // 76
  }                                                                                                           // 19  // 77
                                                                                                              // 20  // 78
  return null;                                                                                                // 21  // 79
};                                                                                                            // 22  // 80
...
/*****************************************************************************/                               // 26  // 84
                                                                                                              // 27  // 85
/**                                                                                                           // 28  // 86
 * Dynamically render templates into regions.                                                                 // 29  // 87
 *                                                                                                            // 30  // 88
 * Layout inherits from Iron.DynamicTemplate and provides the ability to create                               // 31  // 89
 * regions that a user can render templates or content blocks into. The layout                                // 32  // 90
 * and each region is an instance of DynamicTemplate so the template and data                                 // 33  // 91
 * contexts are completely dynamic and programmable in javascript.                                            // 34  // 92
 */                                                                                                           // 35  // 93
Layout = function (options) {                                                                                 // 36  // 94
  var self = this;                                                                                            // 37  // 95
                                                                                                              // 38  // 96
  Layout.__super__.constructor.apply(this, arguments);                                                        // 39  // 97
                                                                                                              // 40  // 98
  options = options || {};                                                                                    // 41  // 99
  this.name = 'Iron.Layout';                                                                                  // 42  // 100
  this._regions = {};                                                                                         // 43  // 101
  this._regionHooks = {};                                                                                     // 44  // 102
  this.defaultTemplate('__IronDefaultLayout__');                                                              // 45  // 103
                                                                                                              // 46  // 104
  // if there's block content then render that                                                                // 47  // 105
  // to the main region                                                                                       // 48  // 106
  if (options.content)                                                                                        // 49  // 107
    this.render(options.content);                                                                             // 50  // 108
};                                                                                                            // 51  // 109
                                                                                                              // 52  // 110
/**                                                                                                           // 53  // 111
 * The default region for a layout where the main content will go.                                            // 54  // 112
 */                                                                                                           // 55  // 113
DEFAULT_REGION = Layout.DEFAULT_REGION = 'main';                                                              // 56  // 114
                                                                                                              // 57  // 115
/**                                                                                                           // 58  // 116
 * Inherits from Iron.DynamicTemplate which gives us the ability to set the                                   // 59  // 117
 * template and data context dynamically.                                                                     // 60  // 118
 */                                                                                                           // 61  // 119
inherits(Layout, Iron.DynamicTemplate);                                                                       // 62  // 120
                                                                                                              // 63  // 121
/**                                                                                                           // 64  // 122
 * Return the DynamicTemplate instance for a given region. If the region doesn't                              // 65  // 123
 * exist it is created.                                                                                       // 66  // 124
 *                                                                                                            // 67  // 125
 * The regions object looks like this:                                                                        // 68  // 126
 *                                                                                                            // 69  // 127
 *  {                                                                                                         // 70  // 128
 *    "main": DynamicTemplate,                                                                                // 71  // 129
 *    "footer": DynamicTemplate,                                                                              // 72  // 130
 *    .                                                                                                       // 73  // 131
 *    .                                                                                                       // 74  // 132
 *    .                                                                                                       // 75  // 133
 *  }                                                                                                         // 76  // 134
 */                                                                                                           // 77  // 135
Layout.prototype.region = function (name, options) {                                                          // 78  // 136
  return this._ensureRegion(name, options);                                                                   // 79  // 137
};                                                                                                            // 80  // 138
                                                                                                              // 81  // 139
/**                                                                                                           // 82  // 140
 * Destroy all child regions and reset the regions map.                                                       // 83  // 141
 */                                                                                                           // 84  // 142
Layout.prototype.destroyRegions = function () {                                                               // 85  // 143
  _.each(this._regions, function (dynamicTemplate) {                                                          // 86  // 144
    dynamicTemplate.destroy();                                                                                // 87  // 145
  });                                                                                                         // 88  // 146
                                                                                                              // 89  // 147
  this._regions = {};                                                                                         // 90  // 148
};                                                                                                            // 91  // 149
                                                                                                              // 92  // 150
/**                                                                                                           // 93  // 151
 * Set the template for a region.                                                                             // 94  // 152
 */                                                                                                           // 95  // 153
Layout.prototype.render = function (template, options) {                                                      // 96  // 154
  // having options is usually good                                                                           // 97  // 155
  options = options || {};                                                                                    // 98  // 156
                                                                                                              // 99  // 157
